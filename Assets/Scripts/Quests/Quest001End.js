...
function OnMouseDown () {
			if (TextBoxOnCheck == 0) {
				...
				//TextBox.GetComponent.<Text>().text = "Villager: Hello baba, some thieves have stolen my gold, could you go retrieve them from the other side of the river?";
				//TextBox.GetComponent.<Text>().text = TextMessage; //changes the message
				QuestName = "Active Quest: None"; // change the quest name
